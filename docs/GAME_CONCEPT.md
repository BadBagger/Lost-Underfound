...
Fully scripted and designed, not yet voiced or produced — see
`script/ACT_02_SCRIPT.json` and `docs/ACT_02_DESIGN.md`.
...
goodbye beat with Bramble and Grommet. Fully scripted and designed, not yet voiced
or produced — see `script/ACT_03_SCRIPT.json` and `docs/ACT_03_DESIGN.md`.
